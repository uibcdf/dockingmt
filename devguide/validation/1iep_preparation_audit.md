...
python -m devtools.audit_1iep_preparation --source-receptor /tmp/1iep_receptorH.pdb --source-ligand /tmp/1iep_ligand.sdf --reference-receptor /tmp/1iep_receptor.pdbqt --reference-ligand /tmp/1iep_ligand.pdbqt --report /tmp/1iep-preparation-audit.json
```
...
calls DockingMT's public preparation functions. The coordinate comparison is exact at
